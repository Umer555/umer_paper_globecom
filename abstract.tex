...
stored in the cloud. To ensure confidentiality of the data, it is ousourced after encryption. However, this makes it difficult to search the encrypted data 
